...
export const whySchool = [
  {
    ...
    reason:
      "We provide students with an exceptional learning environment and top-notch facilities to enhance their education.",
    icon: <FaSchool />,
  },
  {
    id: 2,
    ...
    reason:
      "At our school, we prioritize an environment where students can develop their skills and excel in competitive exams, preparing them for a successful future",
...
export const footerContactNum = [
  {
    id: 1,
    icon: <FaPhone />,
    text: "+91 9922723147, +91 7769802325",
  },
  {
    id: 2,
    icon: <FaEnvelope />,
    text: "bfemschool@gmail.com",
  },
];
